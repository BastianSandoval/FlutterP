...
import 'package:inicio/src/Home/Screens/GalleryPage/Bloc/GalleryBloc.dart';
...
class GalleryPage extends StatefulWidget {
  ...
  GalleryPage(this.nombre);

  @override
  _Gallery createState() => _Gallery();
}

class _Gallery extends State<GalleryPage> {
  GalleryBloc bloc = GalleryBloc();

  @override
  Widget build(BuildContext context) {
    bloc.sinkEvent.add(MostrarGalleria());
    return Scaffold(
      appBar: AppBar(
